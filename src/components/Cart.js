...
import { addToCart, removeFromCart, updateAddress } from '../context/cartSlice'; // Make sure you have an action to update the address
...
function Cart() {
  ...
  return (
    <div className="mt-[69px] md:mt-[90px]  container mx-auto p-4  bg-zinc-200 h-screen">
