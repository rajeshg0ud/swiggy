          ...
          items.length > 0 ?
            <>
              ...
              <div className="w-full lg:w-[24%] bg-white p-6 shadow-sm mt-6 lg:mt-6">
                ...
                <div className="mt-4">
                  <button className="text-xs w-full py-2 border border-dashed border-gray-300 font-bold text-gray-600">
                    APPLY COUPON
                  </button>
                </div>
                <div className="mt-4 flex justify-between">
                  <span className="text-xs">Item Total</span>
                  <span className="text-xs">₹{totalCartValue}</span>
                </div>
                ...
                <div className="mt-2 flex justify-between">
                  ...
                  <span className="text-sm font-bold">₹{totalCartValue + 60}</span>
                </div>
              </div>
            </>
            :
            <div className='flex flex-col justify-center items-center w-screen h-[calc(100vh-110px)]'>
              <img className='w-[40%] md:w-[15%] mt-[-50px]' src={empty_cart} alt='empty cart' />
